...
void SceneManager::LoadSceneTextures()
{
	...
	//Loads in all of the textures from my Textures folder in debug.
	bool bReturn = false;
	...
	bReturn = CreateGLTexture(
		"Textures/Stick.jpg", "stick");

	bReturn = CreateGLTexture(
		"Textures/Paper.jpg", "paper");

	bReturn = CreateGLTexture(
		"Textures/Wood.jpg", "wood");

	bReturn = CreateGLTexture(
		"Textures/Brush.jpg", "brush");
...
void SceneManager::DefineObjectMaterials()
{
	...
	//This is the code from the Applying Lighting class materials.
...
void SceneManager::SetupSceneLights()
{
	...
	//This is the code from the Applying Lighting class materials with some tweaks.
	...
	m_pShaderManager->setVec3Value("lightSources[1].ambientColor", 0.05f, 0.2f, 0.05f);
	...
	m_pShaderManager->setVec3Value("lightSources[2].position", 10.0f, 10.0f, -10.0f);
	m_pShaderManager->setVec3Value("lightSources[2].ambientColor", 0.2f, 0.05f, 0.05f);
	...
	m_pShaderManager->setVec3Value("lightSources[3].ambientColor", 0.05f, 0.05f, 0.2f);
...
void SceneManager::RenderScene()
{
	...
	//Draws the notebook.
	DrawNotebook();
	//Draws the paint pans.
	DrawPaintPans();
	//Draws the brush.
	DrawBrush();
}

void SceneManager::DrawBrush() {
	// declare the variables for the transformations
	glm::vec3 scaleXYZ;
	float XrotationDegrees = 0.0f;
	float YrotationDegrees = 0.0f;
	...
	positionXYZ = glm::vec3(7.0f, 0.3f, 7.0f);
	...
	//Setting shader texture and material
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(7.0f, 0.3f, 8.0f);
	...
	SetShaderColor(0.5, 0.5, 0.5, 1);
	//SetShaderColor(0.57, 0.64, 0.76, 1);
	SetShaderTexture("brush");
	SetTextureUVScale(1.0, 1.0);
	//Applying the tile material.
	SetShaderMaterial("clay");
	// draw the mesh with transformation values
	m_basicMeshes->DrawConeMesh();
}

void SceneManager::DrawPaintPans() {
	// declare the variables for the transformations
	glm::vec3 scaleXYZ;
	float XrotationDegrees = 0.0f;
	float YrotationDegrees = 0.0f;
	...
	//Box
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(1.25f, 0.75f, 1.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-7.0f, 0.375f, 6.0f);
	...
	//Plane
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.5f, 0.0f, 0.4f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-7.0f, 0.755f, 6.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-9.0f, 0.375f, 4.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-9.0f, 0.755f, 4.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-8.0f, 0.375f, 2.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-8.0f, 0.755f, 2.0f);
...
void SceneManager::DrawNotebook() {
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-3.5f, 1.2f, 5.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-3.5f, 1.2f, 7.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-3.5f, 1.2f, 3.0f);
...
void SceneManager::DrawWaterCup() {
	// declare the variables for the transformations
	glm::vec3 scaleXYZ;
	float XrotationDegrees = 0.0f;
	float YrotationDegrees = 0.0f;
	...
	// set the XYZ position for the mesh
	//positionXYZ = glm::vec3(5.0f, 0.5f, -3.0f);
	positionXYZ = glm::vec3(5.0f, 0.6875f, -3.0f);
	...
	//Torus
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(2.45f, 2.45f, 2.45f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(5.0f, 0.6875f, -3.0f);
	///positionXYZ = glm::vec3(5.2f, 0.25f, -3.0f);
	...
	// set the XYZ position for the mesh
	//positionXYZ = glm::vec3(4.65f, 5.5f, -3.0f);
	//positionXYZ = glm::vec3(5.0f, 1.0f, -3.0f);
	positionXYZ = glm::vec3(5.0f, 5.6875f, -3.0f);
	...
	//SetShaderColor(0.50, 0.50, 0.50, 1);
	//SetShaderColor(0.57, 0.64, 0.76, 1);
	SetShaderTexture("water");
	SetTextureUVScale(1.0, 1.0);
	//Applying the tile material.
...
void SceneManager::DrawPaper() {
	...
	SetShaderColor(0.14, 0.45, 0.17, 1);

	//Applying the wood material.
	SetShaderMaterial("wood");
	...
	SetShaderColor(0.79, 0.79, 0.79, 1);
